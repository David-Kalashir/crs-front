...
func (add) Add(app *web.App, cfg mux.Config) {
	...
	uinavbarbus := uinavbarbus.NewBusiness(navbartempl.NewTemplate(cfg.Log), profiletempl.NewTemplate(cfg.Log))
	uisearchpagebus := uisearchpagebus.NewBusiness(searchpagetempl.NewTemplate(cfg.Log), uinavbarbus)
